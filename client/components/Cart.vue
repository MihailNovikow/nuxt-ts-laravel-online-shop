...
const props = defineProps<IProps>(['products', 'shipping', 'related-product', 'payments']);
      ...
      watch(
        selectedShipping, (val) => {
          ...
          axios.post(this.$baseUrl + '/cart/change-shipping', {
            ...
            emit('nav_cart', response.data.data)
          }).catch(e => {
            console.log(e)
            //this.errors.push(e)
          })
